                ...
                >
                    ...
                    <Grid item xs={3}>
                        <FormControl sx={{ m: 1, minWidth: 360 }} size="small">
                            ...
                            {this.props.automovel != null ? <h4>Isto é um {this.props.automovel}</h4> : <div></div>}
                            {this.props.automovel != null ? <img
                                src={"auto/" + this.props.automovel + ".jpg"}
                                width="350.0" onClick={this.handleImage}
                                    ...
                                    <tr>
                                        {this.props.automoveis.map((a, i) =>
                                            a !== this.props.automovel ?
                                                <td key={i}><Button onClick={() => this.alteraAutomovel(a)} variant="outlined">{a}</Button></td>
                                                : <td key={i}></td>
                                        )}
                                    </tr>
                                </tbody>
                            ...
                            <TextField id="tfAutomovel" label="Informe um automóvel" variant="outlined" size="small" />
                        </FormControl>
                    </Grid>
                    <Grid item xs={3}>
                        <Button variant="contained" onClick={this.adicionarAutomovel}>Adicionar Automóvel</Button>
                        <span> </span>
                        <Button variant="contained" onClick={this.deletaAutomovel} color="error">Remover Automóvel</Button>
                    </Grid>
                </Grid>
            </>
        )
